 ...
 */
namespace Longman\ProfilerLibrary\ITDCMS;
...
abstract class Installer
{
    ...
    private static function getPackagePath($event)
    {
        ...
        if ($name !== 'longman/profiler-library-itdcms') {
            return false;
        }
    ...
    {
        return @copy($packagePath.'/src/Controllers/debug1.php', $rootPath.'/core/controllers/itdc/debug1.php');
    }
